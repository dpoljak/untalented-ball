...
public class CharacterController2D : MonoBehaviour 
{
    ...
    public void Jump()
    {
        // TODO moving platforms swag yolo
    ...
    { 
        ...
        /// Swag yolo todo -> Moving platform code
    ...
    public bool HandleHorizontalSlope(ref Vector2 deltaMovement, float angle, bool isGoingRight)
    {
        ...
        deltaMovement.y = Mathf.Tan(angle * Mathf.Deg2Rad) * deltaMovement.x;
        State.IsMovingUpSlope = true;
        State.IsMovingDownSlope = true;
        return true;
    }
